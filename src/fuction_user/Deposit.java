...
public class Deposit extends JDialog implements ActionListener{
	...
	public Deposit(){//构造方法设置布局及注册监听器
		Container cp = this.getContentPane();
		DefaultTableModel jTable1Model = new DefaultTableModel(new String[0][0] ,new String[] {"寄存单号","寄存柜号","电话号码"});//将表设置为二维表
