...
public class Store extends JDialog implements ActionListener{
	...
	public Store(){//构造方法设置布局及注册监听器
		Container cp = this.getContentPane();
		DefaultTableModel jTable1Model = new DefaultTableModel(new String[0][0] ,new String[] {"店面号","联系方式","地址","名称"});//将表设置为二维表
