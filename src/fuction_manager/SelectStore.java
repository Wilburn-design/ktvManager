...
public class SelectStore extends JDialog implements ActionListener{
	...
	static JTable jtStore = new JTable();//设置表格
	JLabel jlSID = new JLabel("1.店面ID");
	JLabel jlScontact = new JLabel("2.联系方式");
	JLabel jlSposition = new JLabel("3.店面地址");
	JLabel jlSname = new JLabel("4.店面名称");
	...
	public SelectStore(){//构造方法设置布局及注册监听器
		...
		this.setTitle("店面查询(增、改输入:1,2,3,4;删输入:1)");//设置标题
